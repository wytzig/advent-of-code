...
if __name__ == "__main__":
    ...
    input_file_puzzle3 = "puzzles/input_puzzle1-1.txt"
    input_file_puzzle4 = "puzzles/input_puzzle1-1.txt"

    answer1, time1, answer2, time2, answer3, time3, answer4, time4 = execute_puzzle(puzzle1, input_file_puzzle1, input_file_puzzle2, input_file_puzzle3, input_file_puzzle4)
