...
def execute_puzzle(puzzle_module, input_file):
    ...
    return answer_part1, elapsed_time_part1, answer_part2, elapsed_time_part2, answer_part3, elapsed_time_part3


if __name__ == "__main__":
    input_file_puzzle1 = "puzzles/input_puzzle1.txt"

    answer1, time1, answer2, time2, answer3, time3 = execute_puzzle(puzzle1, input_file_puzzle1)
